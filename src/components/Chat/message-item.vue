<template lang="pug">
.content-message
    q-chat-message(v-show="account === message.senderAccount", :text="[message.message]", :stamp='timeSent', sent, bg-color='amber-7')
    q-chat-message(v-show="account !== message.senderAccount", :text="[message.message]", :stamp='timeSent', text-color='white', bg-color='primary')
