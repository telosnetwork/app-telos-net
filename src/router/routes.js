const routes = [
  ...
  { path: '/profiles/myProfile/verify/:type', component: () => import('pages/profiles/add/verify-user.vue'), meta: { needBackendLogin: false }, name: 'verifyComm' },
  { path: '/profiles/chat/messages', component: () => import('pages/chats/list/chat.vue'), meta: { needVerifyComm: true, needBackendLogin: false }, name: 'chat' },
  { path: '/profiles/chat', component: () => import('pages/chats/list/chat-list.vue'), meta: { needVerifyComm: true, needBackendLogin: false } },
  ...
  { path: '/profiles/registerApp', component: () => import('pages/apps/add/register-app.vue'), meta: { needVerifyComm: true, needBackendLogin: false }, name: 'registerApp' },
  { path: '/profiles/appList', component: () => import('pages/apps/list/app-list.vue'), meta: { needVerifyComm: true, needBackendLogin: false } },
  { path: '/profiles/authorizedApps', component: () => import('pages/apps/list/authorized-apps.vue'), meta: { needVerifyComm: true, needBackendLogin: false } },
